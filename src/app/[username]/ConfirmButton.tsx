...
export default function ConfirmButton({ token, primaryColor = '#3b82f6', className }: ConfirmButtonProps) {
  ...
  const containerClass = `flex flex-col items-center gap-2 ${className ?? 'pt-4 border-t mt-4'}`;
