                ...
                return (
                  ...
                  >
                    ...
                    <div className="px-2 pb-2 pt-2">
                      <button
                        type="button"
                        className="w-full rounded-md px-3 py-2 text-xs font-semibold hover:opacity-95 focus:outline-none focus:ring-2 focus:ring-offset-2"
                        style={{
                        ...
                        onClick={() => handleDownloadWithFallback(item)}
                      >
                        Descargar
                      </button>
                    </div>
